...
class EmpresaLogisticaTest {
    ...
    void agregarEnvio() {
        ...
        Persona p6=new Repartidor.Builder()
                .id("6")
                .nombre("y")
                .build();
    ...
    void verificarPersona() {
        EmpresaLogistica empresa= EmpresaLogistica.getInstance();
        Persona p1=new Usuario.Builder()
                .id("1")
                .nombre("q")
                .build();
    ...
    void verificarEnvio() {
        ...
        Persona p2=new Repartidor.Builder()
                .id("2")
                .nombre("w")
                .build();
    ...
    void eliminarEnvio() {
        ...
        Persona p9=new Repartidor.Builder()
                .id("2")
                .nombre("t")
                .build();
    ...
    void buscarEnvio() {
        ...
        Persona p15=new Repartidor.Builder()
                .id("15")
                .nombre("t")
                .build();
